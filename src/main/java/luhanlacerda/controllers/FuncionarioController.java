...
import luhanlacerda.dtos.FuncionarioDTO;
import luhanlacerda.entities.Funcionario;
import luhanlacerda.repositories.FuncionarioRepository;
...
public class FuncionarioController {
	...
	private ResponseEntity<?> create(@Valid @RequestBody FuncionarioDTO funcionarioDTO) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(funcionarioSaved);
	}
